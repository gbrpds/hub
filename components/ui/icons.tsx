...
// Conjunto de ícones inline (stroke), sem dependência externa. Todos herdam
// a cor via currentColor e o tamanho padrão 18px (ajustável por props).
...
export function UserCheckIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <circle cx="9" cy="8" r="3" />
      <path d="M3 20a6 6 0 0 1 11.5-2.3" />
...
export function WhatsappIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      ...
      <path d="M8.5 8.8c0-.4.3-.6.6-.6h.7c.3 0 .5.2.6.4l.5 1.2c.1.2 0 .5-.1.6l-.5.5c.5.9 1.2 1.6 2.1 2.1l.5-.5c.2-.2.4-.2.6-.1l1.2.5c.2.1.4.3.4.6v.7c0 .4-.2.6-.6.6a6 6 0 0 1-6-6z" />
    </svg>
  );
}
...
export function ChecklistIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      ...
      <path d="m18 5 1.5 1.5L22 4M18 11l1.5 1.5L22 10" />
    </svg>
  );
}
