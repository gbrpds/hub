            ...
            {group.items.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={cn(
                    "group relative flex items-center gap-3 rounded-sm px-2.5 py-2 text-sm transition-all duration-200 ease-out",
                    active
                      ? "bg-surface-hover text-foreground shadow-[inset_0_0_0_1px_rgba(255,122,61,0.35)]"
